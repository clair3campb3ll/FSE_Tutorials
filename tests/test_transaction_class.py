...
def test_only_expenses(expenses_only_transactions):
    ...
    assert check_financial_health(expenses_only_transactions) == "Overspending"  # Since income is 0
...
def test_only_income(income_only_transactions):
    ...
    assert check_financial_health(income_only_transactions) == "No expenses recorded"  # Since expenses are 0
...
def test_mixed_transactions(sample_transactions):
    ...
    assert calculate_total_expenses(sample_transactions) == Decimal('-4750.50')
    assert calculate_balance(sample_transactions) == Decimal('6749.50') 
    assert check_financial_health(sample_transactions) == "Saving well"  # Since income is greater than expenses
